<?php 
/**
 * Custom Submit Meta box based on Wordpress submit_meta_box
 *
 * @since 2.7.0
 *
 * @param object $post
 */
function fixed_submit_meta_box($post, $args = array() ) {
	global $action;
				...
				<div class="misc-pub-section misc-pub-post-status"><label for="post_status"><?php _e('Status:') ?></label>
					...
					<?php if ( 'publish' == $post->post_status || 'private' == $post->post_status || $can_publish ) { ?>
						...
						<div id="post-status-select" class="hide-if-js">
							...
							<a href="#post_status" class="save-post-status hide-if-no-js button button-primary"><?php _e('OK'); ?></a>
				...
				<div class="misc-pub-section misc-pub-visibility" id="visibility">
					...
					<div id="post-visibility-select" class="hide-if-js">
						...
						<?php if ( $post_type == 'post' && current_user_can( 'edit_others_posts' ) ) : ?>
							<span id="sticky-span"><input id="sticky" name="sticky" type="checkbox" value="sticky" <?php checked( is_sticky( $post->ID ) ); ?> /> <label for="sticky" class="selectit"><?php _e( 'Sticky' ); ?></label><br /></span>
						<?php endif; ?>
						...
						<p><a href="#visibility" class="save-post-visibility hide-if-no-js button button-primary"><?php _e('OK'); ?></a><a href="#visibility" class="cancel-post-visibility hide-if-no-js button-cancel"><?php _e('Cancel'); ?></a></p>
					</div>
					<?php } ?>
				</div><!-- .misc-pub-section -->
				<?php // Revisions Section
				...
				if ( $can_publish ) : // Contributors don't get to choose the date of publish ?>
					<div class="misc-pub-section curtime misc-pub-curtime">
						...
						<a href="#edit_timestamp" class="edit-timestamp hide-if-no-js">
							<span aria-hidden="true"><?php _e( 'Edit' ); ?></span> <span class="screen-reader-text"><?php _e( 'Edit date and time' ); ?></span>
						</a>
						<div id="timestampdiv" class="hide-if-js"><?php
							ob_start();
							touch_time(($action == 'edit'), 1);
							$touch_time = ob_get_contents();
							ob_end_clean();
							echo str_replace('button"', 'button-primary button"', $touch_time );
						?></div>
